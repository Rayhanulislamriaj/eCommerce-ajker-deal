        ...
        <div class="container-fluid-lg">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <div class="image-404">
                        <img src="{{ asset('theme_assets') }}//images/inner-page/404.png" class="img-fluid blur-up lazyload"
                            alt="">
                    </div>
                </div>
                ...
                <div class="col-12">
                    ...
                    <div class="contain-404">
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <button type="submit" class="btn btn-md text-white bg-danger mt-4 mx-auto">
                                Log Out
                            </button>
                        </form>
                    </div>

                    ...
                    <div class="row g-sm-4 g-2">
                        <div class="col-6">
                            <div class="fresh-image-2">
                                <div>
                                    <img src="{{ asset('theme_assets') }}/images/inner-page/about-us/1.jpg"
                        ...
                        <div class="col-6">
                            <div class="fresh-image">
                                <div>
                                    <img src="{{ asset('theme_assets') }}/images/inner-page/about-us/2.jpg"
                                        class="bg-img blur-up lazyload" alt="">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="delivery-list">
                                ...
                                <ul class="delivery-box">
                                    <li>
                                        <div class="delivery-box">
                                            <div class="delivery-icon">
                                                <img src="{{ asset('theme_assets') }}/svg/3/delivery.svg" class="blur-up lazyload" alt="">
                                            </div>
                                    ...
                                    <li>
                                        <div class="delivery-box">
                                            <div class="delivery-icon">
                                                <img src="{{ asset('theme_assets') }}/svg/3/leaf.svg" class="blur-up lazyload" alt="">
                                            </div>
                ...
                <div class="col-12">
                    ...
                    <div class="slider-3_1 product-wrapper">
                        <div>
                            <div class="clint-contain">
                                <div class="client-icon">
                                    <img src="{{ asset('theme_assets') }}/svg/3/work.svg" class="blur-up lazyload" alt="">
                                </div>
                                <h2>10</h2>
                        ...
                        <div>
                            <div class="clint-contain">
                                <div class="client-icon">
                                    <img src="{{ asset('theme_assets') }}/svg/3/buy.svg" class="blur-up lazyload" alt="">
                                </div>
                                <h2>80 K+</h2>
                        ...
                        <div>
                            <div class="clint-contain">
                                <div class="client-icon">
                                    <img src="{{ asset('theme_assets') }}/svg/3/user.svg" class="blur-up lazyload" alt="">
                                </div>
                                <h2>90%</h2>
                ...
                <div class="col-12">
                    <div class="slider-user product-wrapper">
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{ asset('theme_assets') }}/images/inner-page/user/1.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{ asset('theme_assets') }}/images/inner-page/user/2.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{ asset('theme_assets') }}/images/inner-page/user/3.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                        ...
                        <div>
                            <div class="team-box">
                                <div class="team-iamge">
                                    <img src="{{ asset('theme_assets') }}/images/inner-page/user/4.jpg" class="img-fluid blur-up lazyload"
                                        alt="">
                                </div>
                    ...
                    <div class="slider-4-half product-wrapper">
                            ...
                            <div class="reviewer-box">
                                ...
                                <div class="reviewer-profile">
                                    <div class="reviewer-image">
                                        <img src="{{ asset('theme_assets') }}/images/inner-page/user/1.jpg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                        ...
                        <div>
                            <div class="reviewer-box">
                                ...
                                <div class="reviewer-profile">
                                    <div class="reviewer-image">
                                        <img src="{{ asset('theme_assets') }}/images/inner-page/user/2.jpg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                        ...
                        <div>
                            <div class="reviewer-box">
                                ...
                                <div class="reviewer-profile">
                                    <div class="reviewer-image">
                                        <img src="{{ asset('theme_assets') }}/images/inner-page/user/3.jpg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                        ...
                        <div>
                            <div class="reviewer-box">
                                ...
                                <div class="reviewer-profile">
                                    <div class="reviewer-image">
                                        <img src="{{ asset('theme_assets') }}/images/inner-page/user/4.jpg" class="blur-up lazyload"
                                            alt="">
                                    </div>
                    ...
                    <div class="slider-5 ratio_87">
                                ...
                                <div class="blog-box-image">
                                    <div class="blog-image">
                                        <a href="blog-detail.html" class="rounded-3">
                                            <img src="{{ asset('theme_assets') }}/images/veg-2/blog/1.jpg" class="bg-img blur-up lazyload"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <div class="blog-image">
                                        <a href="blog-detail.html" class="rounded-3">
                                            <img src="{{ asset('theme_assets') }}/images/veg-2/blog/2.jpg" class="bg-img blur-up lazyload"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <div class="blog-image">
                                        <a href="blog-detail.html" class="rounded-3">
                                            <img src="{{ asset('theme_assets') }}/images/veg-2/blog/3.jpg" class="bg-img blur-up lazyload"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <div class="blog-image">
                                        <a href="blog-detail.html" class="rounded-3">
                                            <img src="{{ asset('theme_assets') }}/images/veg-2/blog/4.jpg" class="bg-img blur-up lazyload"
                                                alt="">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-image">
                                    <a href="blog-detail.html" class="rounded-3">
                                        <img src="{{ asset('theme_assets') }}/images/veg-2/blog/5.jpg" class="bg-img blur-up lazyload"
                                            alt="">
                                    </a>
                                </div>

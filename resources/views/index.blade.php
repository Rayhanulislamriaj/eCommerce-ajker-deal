            ...
            <div class="row g-4">
                <div class="col-xl-8 ratio_65">
                    <div class="home-contain h-100">
                        <div class="h-100">
                            <img src="{{ asset('theme_assets') }}/images/vegetable/banner/1.jpg"
                    ...
                    <div class="row g-4">
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('theme_assets') }}/images/vegetable/banner/2.jpg"
                                    class="bg-img blur-up lazyload" alt="">
                        ...
                        <div class="col-xl-12 col-md-6">
                            <div class="home-contain">
                                <img src="{{ asset('theme_assets') }}/images/vegetable/banner/3.jpg"
                                    class="bg-img blur-up lazyload" alt="">
                                <div class="home-detail p-center-left home-p-sm w-75">
                                    <div>
            ...
            <div class="banner-slider">
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('theme_assets') }}/images/vegetable/banner/4.jpg" class="bg-img blur-up lazyload"
                            alt="">
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('theme_assets') }}/images/vegetable/banner/5.jpg" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('theme_assets') }}/images/vegetable/banner/6.jpg" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div>
                    <div class="banner-contain hover-effect">
                        <img src="{{ asset('theme_assets') }}/images/vegetable/banner/7.jpg" class="bg-img blur-up lazyload"
                            alt="">
                        <div class="banner-details">
                            <div class="banner-box">
                                <h6 class="text-danger">5% OFF</h6>
                ...
                <div class="col-xxl-3 col-xl-4 d-none d-xl-block">
                    <div class="p-sticky">
                            ...
                            <ul>
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/vegetable.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/cup.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/meats.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/frozen.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/biscuit.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/grocery.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/drink.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/milk.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li class="pb-30">
                                    <div class="category-list">
                                        <img src="{{ asset('theme_assets') }}/svg/1/pet.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                        ...
                        <div class="ratio_medium section-t-space">
                            <div class="home-contain hover-effect">
                                <img src="{{ asset('theme_assets') }}/images/vegetable/banner/11.jpg"
                                ...
                                <div class="review-box">
                                    ...
                                    <div class="review-profile">
                                        <div class="review-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/review/1.jpg"
                                                class="img-fluid blur-up lazyload" alt="">
                                        </div>
                ...
                <div class="col-xxl-9 col-xl-8">
                                ...
                                <div class="row m-0">
                                    <div class="col-12 px-0">
                                        <div class="product-box">
                                            <div class="product-image">
                                                <a href="product-left-thumbnail.html">
                                                    <img src="{{ asset('theme_assets') }}/images/vegetable/product/5.png"
                                                        class="img-fluid blur-up lazyload" alt="">
                                                </a>
                                                <ul class="product-option">
                                                    <li data-bs-toggle="tooltip" data-bs-placement="top" title="View">
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain">
                            <img src="{{ asset('theme_assets') }}/images/vegetable/banner/15.jpg"
                                class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="section-t-space section-b-space">
                        <div class="row g-md-4 g-3">
                            <div class="col-xxl-8 col-xl-12 col-md-7">
                                <div class="banner-contain hover-effect">
                                    <img src="{{ asset('theme_assets') }}/images/vegetable/banner/12.jpg"
                                        class="bg-img blur-up lazyload" alt="">
                            ...
                            <div class="col-xxl-4 col-xl-12 col-md-5">
                                <a href="shop-left-sidebar.html" class="banner-contain hover-effect h-100">
                                    <img src="{{ asset('theme_assets') }}/images/vegetable/banner/13.jpg"
                                        class="bg-img blur-up lazyload" alt="">
                        ...
                        <div>
                            <ul class="product-list">
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/14.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/15.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/16.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/17.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/18.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                        ...
                        <div>
                            <ul class="product-list">
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/19.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/20.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/21.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                ...
                                <li>
                                    <div class="offer-product">
                                        <a href="product-left-thumbnail.html" class="offer-image">
                                            <img src="{{ asset('theme_assets') }}/images/vegetable/product/22.png"
                                                class="blur-up lazyload" alt="">
                                        </a>
                    ...
                    <div class="section-t-space">
                        <div class="banner-contain hover-effect">
                            <img src="{{ asset('theme_assets') }}/images/vegetable/banner/14.jpg"
                                class="bg-img blur-up lazyload" alt="">
                    ...
                    <div class="slider-3-blog ratio_65 no-arrow product-wrapper">
                            ...
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('theme_assets') }}/images/vegetable/blog/1.jpg"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('theme_assets') }}/images/vegetable/blog/2.jpg"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>
                        ...
                        <div>
                            <div class="blog-box">
                                <div class="blog-box-image">
                                    <a href="blog-detail.html" class="blog-image">
                                        <img src="{{ asset('theme_assets') }}/images/vegetable/blog/3.jpg"
                                            class="bg-img blur-up lazyload" alt="">
                                    </a>
                                </div>

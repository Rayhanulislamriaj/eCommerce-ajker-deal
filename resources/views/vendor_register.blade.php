                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="log-in-box">
                        <div class="log-in-title text-center">
                            ...
                            <h4>Apply to became a vendor</h4>
                        </div>
                        ...
                        <div class="input-box">
                            ...
                            @endif
                            <form class="row g-4" method="POST" action="{{ route('vendor.register.post') }}">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-animation w-100" type="submit">Apply</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="https://www.facebook.com/" class="btn google-button w-100">
                                        <img src="{{ asset('theme_assets') }}/images/inner-page/facebook.png"
                        ...
                        <div class="sign-up-box">
                            <h4>Already have an vendor account?</h4>

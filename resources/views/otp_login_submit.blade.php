                    ...
                    <div class="breadscrumb-contain">
                        ...
                        <nav>
                            <ol class="breadcrumb mb-0">
                                ...
                                <li class="breadcrumb-item active">Login OTP</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-6 col-sm-8 mx-auto">
                    <div class="d-flex align-items-center justify-content-center h-100">
                        <div class="log-in-box">
                            ...
                            <form action="{{ route('login.validate.otp') }}" method="POST">
                                @csrf
                                ...
                                <div class="send-box pt-4">
                                    <h5>Didn't get the code? <a href="{{ route('resend.login.otp') }}"
                                            class="theme-color fw-bold">Resend
                                            It</a></h5>
                                </div>

                                <button class="btn btn-animation w-100 mt-3" type="submit">Log In</button>
                        </div>
                        </form>
                    </div>
                </div>
